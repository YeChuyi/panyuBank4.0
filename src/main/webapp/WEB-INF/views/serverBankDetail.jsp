				...
				<div class="layui-form-item">
					<div class="layui-inline">
					    ...
					    <div class="layui-input-inline">
					      <input type="text" name="" class="layui-input" disabled="disabled">
					    </div>
				    </div>
				    ...
				    <div class="layui-inline">
					    ...
					    <div class="layui-input-inline">
					      <input type="text" name="" class="layui-input" disabled="disabled" value="">
					    </div>
				    </div>
				</div>
			  	...
			  	<div class="layui-form-item">
				    <div class="layui-inline">
					    ...
					    <div class="layui-input-inline">
					      <input type="text" name="" class="layui-input" disabled="disabled" value="支行/网点">
					    </div>
				    </div>
