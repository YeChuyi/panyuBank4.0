...
<%
  ...
  //List<MessageBoard> messboardlist=mbs.getRepliedMessageBoard();
 %>
    ...
    <div style="padding: 15px;">
		...
		<fieldset class="layui-elem-field">
            ...
            <div class="layui-field-box">
              ...
              <a href="<%=basePath%>admin/speak.jsp" class="layui-btn layui-btn-sm layui-btn-danger">查看未回复留言</a>
...
layui.use('table', function(){
  ...
  table.render({
    elem: '#test'
    ,url:'RepliedMessageBoardServlet'
...
//     ,toolbar: true //仅开启工具栏，不显示左侧模板
    ...
    ,cols: [[
      ...
      ,{field:'MessUserMessage',width:500, minWidth:130, title: '留言详情'}
      ,{field:'adminMessage', width:500,minWidth:130, title: '回复内容'}
      ,{field:'status', width:80,minWidth:180, title: '状态', sort: true}
